...
[In Canada we used a 4 digit classification of 500 occupations for 2016 in 10 regions located in the Arctic that are part of Nunavut, Northern territories and Yukon.] Each country has its own occupation classification and we did not modify them to make them directly comparable.
...
One of the cases documented in the Arctic resilience assessment is the Skolt Sámi community in the Näätämö river (Inari highlighted in orange in Fig 1B), who have adapted to climate and social pressures in their salmon fishery management [@Huitric2016].
